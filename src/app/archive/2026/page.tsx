...
const Logo = ({ size = "text-xl" }: { size?: string }) => (
    ...
    >
        ...
        <span className="text-gray-600 text-[32px] ml-3">2026</span>
    </div>
);
...
const Body = () => {
    const winners = [
        {
            rank: "1st Place, High School",
            team: "Treat Your Self Fund",
            members: ["Anwitha Alluri", "Ashwika Alluri"],
            color: "text-yellow-500",
            bg: "bg-yellow-500/10 border-yellow-500/20",
        },
        {
            rank: "2nd Place, High School",
            team: "TroTro",
            members: ["Shivani Rajaram", "Amanda Li", "Aarna Kant"],
            color: "text-slate-400",
            bg: "bg-slate-400/10 border-slate-400/20",
        },
        {
            rank: "1st Place, Middle School",
            team: "Hello World",
            members: ["Rose Li", "Eric Lin", "Ryan Chen", "Abhinav Ragavendar"],
            color: "text-yellow-500",
            bg: "bg-amber-700/10 border-amber-700/20",
        },
        {
            rank: "2nd Place, Middle School",
            team: "The Sea Lions",
            members: [
                "Anika Yarlagadda",
                "Kinzom Jaiswal",
