...
const Logo = ({ size = "text-xl" }: { size?: string }) => (
    ...
    >
        ...
        <span className="text-gray-600 text-[32px] ml-3">2024</span>
    </div>
);
    ...
    const winners = [
        {
            rank: "1st Place",
            team: "Chipos",
            members: ["Julian Traut", "Hoa Vo", "Victor Pan", "Vincent Yu"],
        ...
        },
        {
            rank: "2nd Place",
            team: "Untitled",
            members: ["Arjav Shah", "Balin Asklar Coles"],
            color: "text-slate-400",
            bg: "bg-slate-400/10 border-slate-400/20",
        },
        {
            rank: "3rd Place",
            team: "Dr. Kenner's Mess",
            members: [
                "Sophie Liang",
                "Emma Liu",
                "Saachi Badgi",
